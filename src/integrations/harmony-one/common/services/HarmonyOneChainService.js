...
const CHAIN_PATH = path.join(__static, "node", "chain", "chain-harmony-one.js");
const CHAIN_OPTIONS = {
 ...
 */
class HarmonyOneChainService extends EventEmitter {
  constructor(config) {
    super();
    this.config = config;
  }
...
export default HarmonyOneChainService;
