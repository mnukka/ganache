...
import HarmonyOneChainService from "./common/services/HarmonyOneChainService";
...
class HarmonyOne extends Integrations {
  constructor(integrationManager) {
    ...
    this.chain = new HarmonyOneChainService(integrationManager.config);
  ...
  async _listen() {
    ...
    this.chain.on("server-started-data", (data) => {
      console.log('server-started-data', data);
