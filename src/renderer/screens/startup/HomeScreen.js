          ...
          <div className="HomeScreen">
            ...
            <div className="WorkspacesBody">
              ...
              <section>
                ...
                {this.state.flavor === "harmony-one" ? <div style={{height:"0", overflow:"visible", color:"#aaa"}}><small><em>Note: This will start a full <b>Harmony One blockchain localnet</b> and <b>will take about some time to start</b>.<br />Please be patient :)</em></small></div> : ""}
              </section>
            </div>
