          ...
          <div className="HomeScreen">
            ...
            <div className="WorkspacesBody">
              ...
              <section>
                ...
                {this.state.flavor === "harmony-one" ? <div style={{height:"0", overflow:"visible", color:"#aaa"}}><small><em>Note: This will start a <b>Harmony One blockchain localnet</b> and <b>could take about 2 minutes to start</b>.<br />This is not a simulated environment!</em></small></div> : ""}
              </section>
            </div>
